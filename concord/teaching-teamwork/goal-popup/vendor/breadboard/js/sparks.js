...
LogEvent.CIRCUIT_CHANGE_COMPLETED = "Circuit changed completed";
...
EditComponentsView.prototype = {
  ...
  showEditor: function(uid) {
    ...
    componentValueFinished = function (evt, ui) {
      logController.addEvent(LogEvent.CIRCUIT_CHANGE_COMPLETED, {
        "type": "component value change completed",
        "UID": comp.UID,
